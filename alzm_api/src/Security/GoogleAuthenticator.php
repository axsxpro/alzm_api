    ...
    public function authenticate(Request $request): Passport
    {
        ...
        return new SelfValidatingPassport(
            new UserBadge($accessToken->getToken(), function () use ($accessToken, $client) {
                ...
                // Ont-ils déjà été connectés avec Google ? 
                $existingUser = $this->entityManager->getRepository(AppUser::class)->findOneBy(['email' => $email]);
                ...
                if (!$existingUser) {
                    ...
                    $existingUser->setDateRegistration(new \DateTime());
                    // Générer un mot de passe aléatoire
                    // La fonction random_bytes() génère une séquence d'octets aléatoires.
                    // Ici, elle génère 12 octets, ce qui équivaut à 24 caractères hexadécimaux (chaque octet est représenté par deux caractères hexadécimaux).
                    // La fonction bin2hex() convertit la séquence d'octets en une représentation hexadécimale.
