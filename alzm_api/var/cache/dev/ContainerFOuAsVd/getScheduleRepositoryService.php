...
class getScheduleRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/ScheduleRepository.php';

        return $container->privates['App\\Repository\\ScheduleRepository'] = new \App\Repository\ScheduleRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
