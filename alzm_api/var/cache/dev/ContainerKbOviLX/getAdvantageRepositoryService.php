 ...
 */
class getAdvantageRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AdvantageRepository' shared autowired service.
     *
     * @return \App\Repository\AdvantageRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AdvantageRepository.php';

        return $container->privates['App\\Repository\\AdvantageRepository'] = new \App\Repository\AdvantageRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
