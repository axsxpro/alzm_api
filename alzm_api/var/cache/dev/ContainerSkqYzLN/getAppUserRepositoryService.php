 ...
 */
class getAppUserRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AppUserRepository' shared autowired service.
     *
     * @return \App\Repository\AppUserRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AppUserRepository.php';

        return $container->privates['App\\Repository\\AppUserRepository'] = new \App\Repository\AppUserRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
