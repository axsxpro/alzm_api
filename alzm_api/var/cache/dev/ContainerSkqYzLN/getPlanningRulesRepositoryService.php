 ...
 */
class getPlanningRulesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PlanningRulesRepository' shared autowired service.
     *
     * @return \App\Repository\PlanningRulesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PlanningRulesRepository.php';

        return $container->privates['App\\Repository\\PlanningRulesRepository'] = new \App\Repository\PlanningRulesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
