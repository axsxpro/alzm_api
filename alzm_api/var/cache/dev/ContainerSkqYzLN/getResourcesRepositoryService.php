 ...
 */
class getResourcesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ResourcesRepository' shared autowired service.
     *
     * @return \App\Repository\ResourcesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ResourcesRepository.php';

        return $container->privates['App\\Repository\\ResourcesRepository'] = new \App\Repository\ResourcesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
