...
class Patient extends \App\Entity\Patient implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Patient' . "\0" . 'idUser', '' . "\0" . 'App\\Entity\\Patient' . "\0" . 'sold', '' . "\0" . 'App\\Entity\\Patient' . "\0" . 'idPlan'];
        }
     ...
     * {@inheritDoc}
     */
    public function getIdPlan(): \Doctrine\Common\Collections\Collection
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdPlan', []);
     ...
     * {@inheritDoc}
     */
    public function addIdPlan(\App\Entity\Plan $idPlan): static
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addIdPlan', [$idPlan]);

        return parent::addIdPlan($idPlan);
    }

    /**
     * {@inheritDoc}
     */
    public function removeIdPlan(\App\Entity\Plan $idPlan): static
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeIdPlan', [$idPlan]);

        return parent::removeIdPlan($idPlan);
    }
