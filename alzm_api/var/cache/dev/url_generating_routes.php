...
return [
    ...
    'app_schedules_post' => [[], ['_controller' => 'App\\Controller\\ScheduleController::createCourses'], [], [['text', '/api/post/schedules']], [], [], []],
    'app_schedules_put' => [['id'], ['_controller' => 'App\\Controller\\ScheduleController::updateCourses'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/api/put/schedules']], [], [], []],
    'delete_schedules' => [['id'], ['_controller' => 'App\\Controller\\ScheduleController::deleteCourses'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/api/delete/schedules']], [], [], []],
