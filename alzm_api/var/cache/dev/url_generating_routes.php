...
return [
    ...
    'app_all_planning_rules' => [[], ['_controller' => 'App\\Controller\\PlanningRulesController::allPlan'], [], [['text', '/planningrules']], [], [], []],
    'planning_id' => [['id'], ['_controller' => 'App\\Controller\\PlanningRulesController::getPlanningById'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/planningrules']], [], [], []],
    'app_plannings_post' => [['id'], ['_controller' => 'App\\Controller\\PlanningRulesController::createUsers'], [], [['text', '/plannings-rules'], ['variable', '/', '[^/]++', 'id', true], ['text', '/post/coachs']], [], [], []],
